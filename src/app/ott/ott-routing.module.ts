...
const routes: Routes = [
  ...
  {path:'ottvideotype1/:type/:episode/:season/:series',component:Ottvideotype1Component},
  {path:'ottvideotype2/:type/:episode/:season/:series',component:Ottvideotype2Component},
